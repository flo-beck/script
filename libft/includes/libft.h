...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2013/11/20 10:11:10 by fbeck             #+#    #+#             */
/*   Updated: 2014/04/26 19:48:27 by fbeck            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_list				*ft_lstpush(t_list **alst, void *content,
		size_t content_size);
...
void				ft_swap_lst2(t_list *s1, t_list *s2);
void				ft_sort_lst(t_list *list,
		int (*ft_test_elem)(t_list *e1, t_list *e2));
/*
** MISC
*/
